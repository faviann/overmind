...
internal sealed class Workstreams(MemoryDatabase database, WriteSafetyGate writeSafety)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await database.InsertTraceRawAsync(context.AgentId, targetNamespace, context.SessionId, "tool_call", new
        {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await database.InsertTraceRawAsync(context.AgentId, row.Namespace, context.SessionId, "workstream_checkout", new
        {
            uuid = row.Uuid,
            title = row.Title,
            created
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await database.InsertTraceRawAsync(context.AgentId, row.Namespace, context.SessionId, "workstream_checkin", new
        {
            uuid = row.Uuid,
            title = row.Title,
            status
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await database.InsertTraceRawAsync(context.AgentId, targetNamespace, context.SessionId, "handoff", new
        {
            uuid = row.Uuid,
            title = row.Title
