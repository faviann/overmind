...
grep -Fq '<!-- report-afk:v1 repo=acme/widget artifacts=pr:10,pr:11,pr:12,pr:13,issue:201 -->' "$report"
...
[[ "$(grep -Ec '^(pr|issue) edit ' "$events")" == 5 ]]
